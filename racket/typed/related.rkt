...
(define N : Positive-Integer 1)
(define N-1 : Nonnegative-Integer (- N 1))
...
(define-type PostIndex Nonnegative-Integer)
(define-type PostIndices (Listof PostIndex))
(define-type RelatedCounts (Vectorof Nonnegative-Integer))
...
(define-type VecLen Nonnegative-Integer)
